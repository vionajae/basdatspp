 ...
 * @author Client
 */
public class FSpp extends javax.swing.JInternalFrame {
    void kosong(){
        tahun.setText("");
        nominal.setText("");
    }
    /**
     * Creates new form FSpp
     */
    public FSpp() {
        initComponents();
    }
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        ...
        tahun.setText(tabel.getValueAt(no_baris, 1).toString());
        nominal.setText(tabel.getValueAt(no_baris, 2).toString());
    }//GEN-LAST:event_tabelMouseClicked

    private void simpanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_simpanMouseClicked
        // TODO add your handling code here:
        String th = tahun.getText();
        String no = nominal.getText();
        String sql = "insert into spp(tahun,nominal) values('"+th+"','"+no+"')";
        ModelDatabase md = new ModelDatabase();
        if(md.rubahData(sql)){
    ...
    private void updateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateMouseClicked
        ...
        String th = tahun.getText();
        String no = nominal.getText();
        String sql = "update spp set tahun='"+th+"',nominal='"+no+"' where id_spp="+kode;
        ModelDatabase md = new ModelDatabase();
        if(md.rubahData(sql)){
